...
int lua_GameAnalyticsLua_GameAnalytics_configureAutoDetectAppVersion(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    {
        bool arg0;
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ga.GameAnalytics:configureAutoDetectAppVersion");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_GameAnalyticsLua_GameAnalytics_configureAutoDetectAppVersion'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ga.GameAnalytics:configureAutoDetectAppVersion",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_GameAnalyticsLua_GameAnalytics_configureAutoDetectAppVersion'.",&tolua_err);
#endif
    return 0;
}
